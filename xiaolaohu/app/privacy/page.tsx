    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      {lang === "zh" ? (
        <div className="prose max-w-none text-gray-700 leading-relaxed space-y-4">
          ...
          <p>本网站使用 Google AdSense 展示广告。Google 可能根据您的浏览行为投放个性化广告。如需退出，请访问 Google 广告设置页面。</p>
          <h2 className="text-xl font-semibold text-gray-800">Cookie</h2>
          <p>本站使用 localStorage 存储您的语言偏好（中文/英文）。广告服务商可能设置 Cookie 用于广告个性化。</p>
        ...
        <div className="prose max-w-none text-gray-700 leading-relaxed space-y-4">
          ...
          <p>This website uses Google AdSense to display advertisements. Google may serve personalized ads based on your browsing behavior. To opt out, visit Google's Ad Settings.</p>
