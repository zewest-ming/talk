    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      {lang === "zh" ? (
        <div className="prose max-w-none text-gray-700 leading-relaxed space-y-4">
          <p>欢迎来到<strong>鸣鸣大老虎</strong>！这里是一个记录小老虎（鸣鸣）成长故事的地方。</p>
          <p>我是鸣鸣妈妈，一个普通的新手妈妈，在陪伴孩子成长的路上，记录下那些珍贵的瞬间、踩过的坑和积累的经验。</p>
          ...
          <p>微信搜索「鸣鸣大老虎」关注我们的公众号，获取最新内容！</p>
        </div>
      ) : (
        <div className="prose max-w-none text-gray-700 leading-relaxed space-y-4">
          <p>Welcome to <strong>MingMing Tiger</strong>! A parenting blog documenting the growth of our little tiger.</p>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <p>Follow our WeChat public account: 鸣鸣大老虎</p>
        </div>
      )}
    </div>
  );
